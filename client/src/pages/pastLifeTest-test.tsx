...
export default function PastLifeTestTest() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FB] flex flex-col font-sans">
      <SEO title="당신의 전생은 어떤 모습이었을까?" description="전생에 당신은 어떤 인생을 살았을까요? 중세의 기사, 신비한 마법사, 혹은 단순한 농부? 이 독특한 심리 테스트를 통해 당신의 과거를 파헤쳐보고, 잊혀진 기억 속의 진실을 찾아보세요! 상상도 못했던 당신의 숨겨진 전생을 밝혀줄 거예요." />
      <Navigation />
      {!hasStarted ? (
        <main className="flex-grow max-w-3xl mx-auto w-full px-4 py-12 pb-24 flex flex-col items-center">
          <div className="bg-white rounded-[2rem] p-8 md:p-12 shadow-md flex-col justify-center text-center w-full mb-10 border border-neutral-100">
            ...
            <h1 className="text-3xl md:text-5xl font-extrabold mb-6 tracking-tight text-neutral-900">당신의 전생은 어떤 모습이었을까?</h1>
            <p className="text-lg md:text-xl text-neutral-500 mb-10 leading-relaxed">궁금한 당신의 무의식 속 이야기!</p>
          ...
          <div className="bg-white/60 border border-neutral-200 rounded-2xl p-8 text-left w-full mt-8 prose prose-neutral max-w-none">
            ...
            <p className="text-neutral-600 mb-4">당신의 전생은 어떤 모습이었을까?는 당신의 심리를 깊이 있게 분석하여 숨겨진 성향을 찾아냅니다. 전생에 당신은 어떤 인생을 살았을까요? 중세의 기사, 신비한 마법사, 혹은 단순한 농부? 이 독특한 심리 테스트를 통해 당신의 과거를 파헤쳐보고, 잊혀진 기억 속의 진실을 찾아보세요! 상상도 못했던 당신의 숨겨진 전생을 밝혀줄 거예요.</p>
        ...
        <main className="flex-grow max-w-2xl mx-auto w-full px-4 py-8 flex flex-col">
          ...
          <div className="bg-white rounded-3xl p-8 md:p-10 shadow-lg flex-grow flex flex-col justify-center text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-10 leading-relaxed text-neutral-800 break-keep">{question?.question || question?.questionText || "당신의 전생은 어떤 모습이었을까?"}</h2>
