...
export default function PastLifeTestTest() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FB] flex flex-col font-sans">
      <SEO title="너의 전생은 어떤 모습이었을까?" description="전생에 대한 호기심은 누구에게나 있어요. 당신의 영혼이 얼마나 다채로운 삶을 살았는지 알아보세요! 이 테스트를 통해 당신의 과거를 재조명하고, 다시 태어난 진정한 이유를 찾을 수 있을 거예요. 지금 바로 시작하세요!" url="https://mbtifinder.com/pastLifeTest-test" />
      <Navigation />
      {!hasStarted ? (
        <main className="flex-grow max-w-3xl mx-auto w-full px-4 py-12 pb-24 flex flex-col items-center">
          <div className="bg-white rounded-[2rem] p-8 md:p-12 shadow-md flex-col justify-center text-center w-full mb-10 border border-neutral-100">
            ...
            <h1 className="text-3xl md:text-5xl font-extrabold mb-6 tracking-tight text-neutral-900">너의 전생은 어떤 모습이었을까?</h1>
            <p className="text-lg md:text-xl text-neutral-500 mb-10 leading-relaxed">과거의 삶이 현재의 너에게 어떤 영향을 미쳤을까?</p>
          ...
          <div className="bg-white/60 border border-neutral-200 rounded-2xl p-8 text-left w-full mt-8 prose prose-neutral max-w-none">
            ...
            <p className="text-neutral-600 mb-4">너의 전생은 어떤 모습이었을까?는 당신의 심리를 깊이 있게 분석합니다. 전생에 대한 호기심은 누구에게나 있어요. 당신의 영혼이 얼마나 다채로운 삶을 살았는지 알아보세요! 이 테스트를 통해 당신의 과거를 재조명하고, 다시 태어난 진정한 이유를 찾을 수 있을 거예요. 지금 바로 시작하세요!</p>
        ...
        <main className="flex-grow max-w-2xl mx-auto w-full px-4 py-8 flex flex-col">
          ...
          <div className="bg-white rounded-3xl p-8 md:p-10 shadow-lg flex-grow flex flex-col justify-center text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-10 leading-relaxed text-neutral-800 break-keep">{question?.question || question?.questionText || "너의 전생은 어떤 모습이었을까?"}</h2>
