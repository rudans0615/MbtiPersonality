          ...
          <CardContent className="p-0 space-y-8">
            ...
            <section>
              ...
              <p className="text-neutral-700 leading-relaxed">
                이 약관은 심리테스트 플랫폼(이하 "서비스")이 제공하는 인터넷 관련 서비스(이하 "서비스")를 
            ...
            <section>
              ...
              <div className="text-neutral-700 leading-relaxed space-y-2">
                ...
                <p>③ 서비스가 제공하는 심리검사 결과는 참고용이며, 전문적인 심리상담이나 의학적 진단을 대체할 수 없습니다.</p>
                <p>④ 이용자가 서비스를 통해 얻은 정보로 인한 손해에 대해서 서비스는 책임을 지지 않습니다.</p>
              </div>
            </section>
