...
export default function HealingJourneyTest() {
  ...
  return (
    <div className="min-h-screen bg-pink-50/30">
      <SEO title="너의 힐링 여행 스타일은?" description="하루하루 바쁜 일상 속에서 힘든 나에게 필요한 힐링의 순간은 언제일까? 다양한 상황 속에서 네가 어떤 힐링 여행 스타일인지를 알아보자!" url="https://mbtifinder.com/healingJourney-test" keywords="CAREER, 너의, 힐링, 여행, 스타일은?" />
      <Navigation />
      {!hasStarted ? (
        <main className="flex-grow max-w-3xl mx-auto w-full px-4 py-12 pb-24 flex flex-col items-center">
          <div className="bg-white/90 backdrop-blur-sm rounded-[2rem] p-8 md:p-12 shadow-xl border border-white/60 flex-col justify-center text-center w-full mb-10">
            ...
            <h1 className="text-3xl md:text-5xl font-extrabold mb-6 tracking-tight text-neutral-900">너의 힐링 여행 스타일은?</h1>
            <p className="text-lg md:text-xl text-neutral-500 mb-10 leading-relaxed">지친 마음을 싸이하고 떠나보자!</p>
          ...
          <div className="bg-white/60 backdrop-blur-sm border border-white/60 rounded-2xl p-8 text-left w-full mt-8 prose prose-neutral max-w-none">
            ...
            <p className="text-neutral-600 mb-4">너의 힐링 여행 스타일은?는 당신의 심리를 깊이 있게 분석합니다. 하루하루 바쁜 일상 속에서 힘든 나에게 필요한 힐링의 순간은 언제일까? 다양한 상황 속에서 네가 어떤 힐링 여행 스타일인지를 알아보자!</p>
              ...
              <div className="p-8 md:p-10 relative z-10">
                <div className="text-center mb-10">
                  ...
                  <h2 className="text-2xl md:text-[1.7rem] font-bold text-neutral-800 leading-snug tracking-tight break-keep">
                    {question?.question || question?.questionText || "너의 힐링 여행 스타일은?"}
                  </h2>
                </div>
