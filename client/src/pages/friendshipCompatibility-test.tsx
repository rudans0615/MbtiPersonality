...
export default function FriendshipCompatibilityTest() {
  ...
  return (
    <div className="min-h-screen bg-pink-50/30">
      <SEO title="내 친구와의 우정, 얼마나 잘 맞을까?" description="너와 친구의 우정의 깊이를 테스트해봐! 당신의 성향이 친구와 얼마나 잘 맞는지 알게 될 거야. 친구 관계를 보다 즐겁고 특별하게 만들어보자!" url="https://mbtifinder.com/friendshipCompatibility-test" keywords="PERSONALITY, 내, 친구와의, 우정,, 얼마나, 잘, 맞을까?" />
      <Navigation />
      {!hasStarted ? (
        <main className="flex-grow max-w-3xl mx-auto w-full px-4 py-12 pb-24 flex flex-col items-center">
          <div className="bg-white/90 backdrop-blur-sm rounded-[2rem] p-8 md:p-12 shadow-xl border border-white/60 flex-col justify-center text-center w-full mb-10">
            ...
            <h1 className="text-3xl md:text-5xl font-extrabold mb-6 tracking-tight text-neutral-900">내 친구와의 우정, 얼마나 잘 맞을까?</h1>
            <p className="text-lg md:text-xl text-neutral-500 mb-10 leading-relaxed">너와 친구의 궁합 테스트!</p>
          ...
          <div className="bg-white/60 backdrop-blur-sm border border-white/60 rounded-2xl p-8 text-left w-full mt-8 prose prose-neutral max-w-none">
            ...
            <p className="text-neutral-600 mb-4">내 친구와의 우정, 얼마나 잘 맞을까?는 당신의 심리를 깊이 있게 분석합니다. 너와 친구의 우정의 깊이를 테스트해봐! 당신의 성향이 친구와 얼마나 잘 맞는지 알게 될 거야. 친구 관계를 보다 즐겁고 특별하게 만들어보자!</p>
              ...
              <div className="p-8 md:p-10 relative z-10">
                <div className="text-center mb-10">
                  ...
                  <h2 className="text-2xl md:text-[1.7rem] font-bold text-neutral-800 leading-snug tracking-tight break-keep">
                    {question?.question || question?.questionText || "내 친구와의 우정, 얼마나 잘 맞을까?"}
                  </h2>
                </div>
