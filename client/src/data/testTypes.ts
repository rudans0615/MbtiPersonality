...
export const testTypes: TestType[] = [
  {
    ...
    subtitle: "숨겨진 기억 속에서 과거의 나를 발견해 보세요!",
    description: "당신은 어떤 삶을 살았고, 어떤 경험을 쌓았을까요? 이 테스트는 당신의 전생을 알려주고, 그 안에서 어떻게 성장을 했는지 보여줄 것입니다. 재미있고 흥미로운 질문에 답하면서 당신의 숨겨진 이야기를 찾아보세요!",
    emoji: "✨",
