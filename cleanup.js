...
appContent = appContent.replace(/import MbtiMatchTestTest from "@\/pages\/mbtiMatchTest-test";\n/, '');
appContent = appContent.replace(/import MbtiMatchTestResults from "@\/pages\/mbtiMatchTest-results";\n/, '');
appContent = appContent.replace(/<Route path="\/mbtiMatchTest-test" component={MbtiMatchTestTest} \/>\n\s*/, '');
appContent = appContent.replace(/<Route path="\/mbtiMatchTest-results" component={MbtiMatchTestResults} \/>\n\s*/, '');
